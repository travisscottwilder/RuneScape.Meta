...
CYCLE:
CYCLE:
	Sell big bones + misc loot to fund arrows/runes

	RANGE:
		-> Purchase only addy arrows once you can use em
...
LOCATIONS:
  ...
  Giant Frogs [bank big bones] @ Lumbridge Swamp
		Weakness to earth magic spells
        Benifits:
            Big Bones
            Runes
            Coins
	...
	Hill Giants [bank big bones] @ Edgeville Dungeon
      Weakness to earth magic spells 
	  Benefits:
        Big Bones
        Limpwurt roots
    ...
    Ogress Warriors @ Corsair Cove Dungeon
	  ...
	  Benifits:
        ...
        Very AFK
      Location:
        Southwest area of the map "Corsair Cove" then inside a dungeon
